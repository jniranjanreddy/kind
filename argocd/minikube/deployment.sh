#!/usr/bin/env bash
#
# Installs Argo CD into the "argocd" namespace of a local minikube cluster,
# and registers the Application in application.yaml — tracks the "minikube"
# branch of https://github.com/jniranjanreddy/argocd.git (path "k8s"),
