#!/usr/bin/env bash
#
# Installs MongoDB (standalone) into the "mongodb" namespace of a local kind
# cluster via the Bitnami Helm chart, using values.yaml, then deploys Mongo
# Express (mongo-express.yaml) as a web UI in front of it.
#
# Usage:
